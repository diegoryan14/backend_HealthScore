...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../especialista.test-samples';

import { EspecialistaService, RestEspecialista } from './especialista.service';

const requireRestSample: RestEspecialista = {
  ...sampleWithRequiredData,
  dataFormacao: sampleWithRequiredData.dataFormacao?.toJSON(),
